...
var css = {
  ...
  processors: [
    require('postcss-assets')({
      loadPaths: ['images/'],
      basePath: dir.build,
      baseUrl: '/wp-content/themes/coursaty/'
    }),
...
const audios = {
    src        : dir.src + 'assets/audios/**/*',
    build      : dir.build + 'assets/audios'
};

gulp.task('audios', () => {
    return gulp.src(audios.src)
        .pipe(gulp.dest(audios.build));
});
...
// run all tasks
gulp.task('build', ['theme', 'php', 'css', 'fonts', 'audios', 'js']);
