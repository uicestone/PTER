<div class="sendgrid-filters-container <?php echo ( version_compare( get_bloginfo("version"), '3.7.10', '>' ) ? "wordpress-new" : "" ); ?>">
  <div class="sendgrid-filters">
    ...
    <div class="pull-left">
      <label for="sendgrid-start-date">开始日期</label>
      <input type="text" id="sendgrid-start-date" name="sendgrid_start_date" />
    </div>
    <div class="pull-left">
      <label for="sendgrid-end-date">结束日期</label>
      <input type="text" id="sendgrid-end-date" name="sendgrid_end_date" />
    </div>
    <a href="#" id="sendgrid-apply-filter" data-filter="<?php if ( isset( $_GET['page'] ) and "sendgrid-statistics" == sanitize_text_field( $_GET['page'] ) ) { ?>sendgrid-statistics<?php } else { ?>dashboard<?php } ?>" class="button button-primary">查询</a>
  </div>
...
<div class="sendgrid-container
  ...
  <div class="widget others" id="deliveries">
    <div class="widget-top">
      <div class="widget-title"><h4>发送</h4></div>
    </div>
    <div class="widget-inside">
      <div class="row clearfix">
        <div class="pull-left">
          <span class="square" style="background-color: rgb(50,135,1);"></span><span>请求</span>
        </div>
        <div id="requests" class="pull-right">0</div>
      </div>
      <div class="row clearfix">
        <div class="pull-left">
          <span class="square" style="background-color: rgb(188,213,22);"></span><span>丢弃</span>
        </div>
        <div id="drop" class="pull-right">0%</div>
      </div>
      <div class="row clearfix">
        <div class="pull-left">
          <span class="square" style="background-color: rgb(251,166,23);"></span><span>送达</span>
        </div>
  ...
  <div class="widget others" id="compliance">
    <div class="widget-top">
      <div class="widget-title"><h4>投诉</h4></div>
    </div>
    <div class="widget-inside">
      <div class="row clearfix">
        <div class="pull-left">
          <span class="square" style="background-color: rgb(251,229,0);"></span><span>垃圾邮件报告</span>
        </div>
        <div id="spam-reports" class="pull-right">0%</div>
      </div>
      <div class="row clearfix">
        <div class="pull-left">
          <span class="square" style="background-color: rgb(17,133,193);"></span><span>退回</span>
        </div>
        <div id="bounces" class="pull-right">0%</div>
      </div>
      <div class="row clearfix">
        <div class="pull-left">
          <span class="square" style="background-color: rgb(188,208,209);"></span><span>被屏蔽</span>
        </div>
  ...
  <div class="widget others" id="engagement">
    <div class="widget-top">
      <div class="widget-title"><h4>参与度</h4></div>
    </div>
    <div class="widget-inside">
      <div class="row clearfix">
        <div class="pull-left">
          <span class="square" style="background-color: rgb(62,68,192);"></span><span>取消订阅</span>
        </div>
        <div id="unsubscribes" class="pull-right">0%</div>
      </div>
      <div class="row clearfix">
        <div class="pull-left">
          <span class="square" style="background-color: rgb(255,0,224);"></span><span>独立打开</span>
        </div>
        <div id="unique-opens" class="pull-right">0%</div>
      </div>
      <div class="row clearfix">
        <div class="pull-left">
          <span class="square" style="background-color: rgb(224,68,40);"></span><span>打开</span>
        </div>
        <div id="opens" class="pull-right">0%</div>
      </div>
      <div class="row clearfix">
        <div class="pull-left">
          <span class="square" style="background-color: rgb(50,135,1);"></span><span>点击</span>
        </div>
  ...
  <?php if ( ! isset ($_GET['page'] ) or "sendgrid-statistics" != sanitize_text_field( $_GET['page'] ) ) { ?>
    <a href="index.php?page=sendgrid-statistics" class="more-statistics">查看图表</a>
    <br class="clearfix-clear"/>
  <?php } ?>
</div>
