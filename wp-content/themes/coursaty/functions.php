...
add_action('wp', function() {
	...
	wp_register_style('style', get_stylesheet_directory_uri() . '/style.css', array(), '1.0.10');
	...
	wp_register_script('scripts', get_stylesheet_directory_uri() . '/assets/js/scripts.js', array('jquery'), '1.0.1', true);
