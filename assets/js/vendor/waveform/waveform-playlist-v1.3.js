	      ...
	      this.mediaRecorder.ondataavailable = function (e) {
	        ...
	        if (!_this.working) {
	          ...
	          loader.load().then(function (audioBuffer) {
                ...
                var recentSeconds = 3;
                if (_this.recordingTrack.buffer.duration > recentSeconds) {
                  var recentSamples = recentSeconds * _this.recordingTrack.buffer.sampleRate;
                  var recentSamplesIntegral = _this.recordingTrack.buffer.getChannelData(0)
                    .slice(-recentSamples)
	  ...
	  _createClass(_class, [{
	    ...
	    */
	    ...
	    value: function renderControls(data) {
	      ...
	      }, ['静音']), (0, _h2.default)('span.btn.btn-default.btn-xs.btn-solo' + soloClass, {
	        onclick: function onclick() {
